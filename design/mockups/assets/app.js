...
const NAV = [
  ...
  { label: 'Catalog', items: [
    ...
    { id: 'resources', ico: 'database', text: 'Resources', href: '#', count: 57 },
    { id: 'links', ico: 'link', text: 'Links', href: '#' },
  ]},
  { label: 'Architecture', items: [
    ...
    { id: 'capabilities', ico: 'extension', text: 'Capabilities', href: '#' },
    { id: 'entities', ico: 'table', text: 'Entities', href: '#' },
  ]},
  { label: 'Infrastructure', items: [
    { id: 'clusters', ico: 'lan', text: 'Clusters', href: 'clusters-list.html', count: 8 },
    { id: 'nodes', ico: 'dns', text: 'Nodes', href: '#' },
  ...
  { label: 'CI / CD', items: [
    ...
    { id: 'ci-servers', ico: 'memory', text: 'CI Servers', href: '#' },
  ]},
  { label: 'Governance', items: [
    ...
    { id: 'metrics', ico: 'monitoring', text: 'Metrics', href: '#' },
  ]},
  { label: 'Organization', items: [
    { id: 'groups', ico: 'groups', text: 'Groups', href: '#' },
