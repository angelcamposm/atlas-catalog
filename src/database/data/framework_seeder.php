...
return [
    ...
    [
        'language_name' => 'PHP',
        'name' => 'CakePHP',
        'description' => 'A rapid development framework for PHP that provides an extensible architecture for developing, maintaining, and deploying web applications.',
        'icon' => 'cakephp.svg',
        'is_enabled' => true,
    ...
    [
        'language_name' => 'JavaScript',
        'name' => 'NextJS',
        'description' => 'A React framework for production that enables features like server-side rendering, static site generation, and automatic code splitting.',
        'icon' => 'next-js.svg',
        'is_enabled' => true,
