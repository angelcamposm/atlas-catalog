...
class UpdateBusinessDomainRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('update', $this->route('business_domain')) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['sometimes', 'nullable', 'string', 'max:255', Rule::unique('business_domains')->ignore($this->businessDomain)],
        ];
    }
}
