...
#[CoversClass(WorkflowJobObserver::class)]
class WorkflowJobObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = WorkflowJob::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = WorkflowJob::factory()->create(['created_by' => $user2->id]);
