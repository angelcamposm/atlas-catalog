...
#[CoversClass(ApiStatusObserver::class)]
class ApiStatusObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ApiStatus::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ApiStatus::factory()->create(['created_by' => $user2->id]);
