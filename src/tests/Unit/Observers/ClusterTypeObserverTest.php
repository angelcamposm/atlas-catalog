...
#[CoversClass(ClusterTypeObserver::class)]
class ClusterTypeObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ClusterType::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ClusterType::factory()->create(['created_by' => $user2->id]);
