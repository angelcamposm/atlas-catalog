...
#[CoversClass(WorkflowRunObserver::class)]
class WorkflowRunObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = WorkflowRun::factory()->create();
    ...
    public function test_updating_sets_updated_by(): void
    {
        ...
        $model->result = WorkflowRunResult::Success->value;
        $model->save();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = WorkflowRun::factory()->create(['created_by' => $user2->id]);
