...
#[CoversClass(FrameworkObserver::class)]
class FrameworkObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = Framework::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = Framework::factory()->create(['created_by' => $user2->id]);
