...
#[CoversClass(ResourceCategoryObserver::class)]
class ResourceCategoryObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ResourceCategory::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ResourceCategory::factory()->create(['created_by' => $user2->id]);
