...
#[CoversClass(ComplianceStandardObserver::class)]
class ComplianceStandardObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ComplianceStandard::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ComplianceStandard::factory()->create(['created_by' => $user2->id]);
