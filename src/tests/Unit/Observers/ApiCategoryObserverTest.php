...
#[CoversClass(ApiCategoryObserver::class)]
class ApiCategoryObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ApiCategory::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ApiCategory::factory()->create(['created_by' => $user2->id]);
