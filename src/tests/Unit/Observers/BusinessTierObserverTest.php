...
#[CoversClass(BusinessTierObserver::class)]
class BusinessTierObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = BusinessTier::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = BusinessTier::factory()->create(['created_by' => $user2->id]);
