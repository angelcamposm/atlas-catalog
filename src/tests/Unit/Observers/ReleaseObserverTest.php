...
#[CoversClass(ReleaseObserver::class)]
class ReleaseObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = Release::factory()->create(['created_by' => $user2->id]);
