...
#[CoversClass(ApiAccessPolicyObserver::class)]
class ApiAccessPolicyObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ApiAccessPolicy::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ApiAccessPolicy::factory()->create(['created_by' => $user2->id]);
