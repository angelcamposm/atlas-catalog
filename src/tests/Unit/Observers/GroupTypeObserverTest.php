...
#[CoversClass(GroupTypeObserver::class)]
class GroupTypeObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = GroupType::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = GroupType::factory()->create(['created_by' => $user2->id]);
