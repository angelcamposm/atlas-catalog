...
#[CoversClass(AuthenticationMethodObserver::class)]
class AuthenticationMethodObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = AuthenticationMethod::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = AuthenticationMethod::factory()->create(['created_by' => $user2->id]);
