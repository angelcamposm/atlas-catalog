...
use App\Models\User;
use App\Observers\GroupMemberRoleObserver;
...
#[CoversClass(GroupMemberRoleObserver::class)]
class GroupMemberRoleObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = GroupMemberRole::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = GroupMemberRole::factory()->create(['created_by' => $user2->id]);
