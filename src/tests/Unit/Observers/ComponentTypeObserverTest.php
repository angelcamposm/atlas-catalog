...
#[CoversClass(ComponentTypeObserver::class)]
class ComponentTypeObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ComponentType::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ComponentType::factory()->create(['created_by' => $user2->id]);
