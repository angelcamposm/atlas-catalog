...
#[CoversClass(ServiceStatusObserver::class)]
class ServiceStatusObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ServiceStatus::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ServiceStatus::factory()->create(['created_by' => $user2->id]);
