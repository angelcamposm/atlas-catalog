...
#[CoversClass(EnvironmentObserver::class)]
class EnvironmentObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = Environment::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = Environment::factory()->create(['created_by' => $user2->id]);
