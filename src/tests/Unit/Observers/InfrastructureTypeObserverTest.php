...
#[CoversClass(InfrastructureTypeObserver::class)]
class InfrastructureTypeObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = InfrastructureType::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = InfrastructureType::factory()->create(['created_by' => $user2->id]);
