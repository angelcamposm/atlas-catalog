...
#[CoversClass(BusinessDomainObserver::class)]
class BusinessDomainObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = BusinessDomain::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = BusinessDomain::factory()->create(['created_by' => $user2->id]);
