...
#[CoversClass(ServiceAccountObserver::class)]
class ServiceAccountObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = ServiceAccount::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = ServiceAccount::factory()->create(['created_by' => $user2->id]);
