...
#[CoversClass(LinkCategoryObserver::class)]
class LinkCategoryObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $model = LinkCategory::factory()->create();
    ...
    public function test_creating_does_not_overwrite_created_by(): void
    {
        ...
        $model = LinkCategory::factory()->create(['created_by' => $user2->id]);
