...
| **Deployments**    | _(sin rutas)_         | ❌ Controller sin registrar                                                                                    | 🔴 No expuesto |
...
_Plan generado el 4 de marzo de 2026 — Actualizado con TODOs del PR #39_
_Branch: `analysis/backend-implementation-plan`_
