...
/**
 * E2E tests for the Security Auth Methods page.
 * Task 5.2 — Auth Methods E2E.
 */
test.describe("Security Auth Methods", () => {
    const BASE_URL = "/es/security/auth-methods";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /auth|autenticaci/i })
            .isVisible()
            .catch(() => false);
