...
/**
 * E2E tests for the Service Accounts page.
 * Task 5.3 — Service Accounts E2E.
 */
test.describe("Service Accounts", () => {
    const BASE_URL = "/es/security/service-accounts";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /service accounts|cuentas de servicio/i })
            .isVisible()
            .catch(() => false);
