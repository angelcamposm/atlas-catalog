...
/**
 * E2E tests for the Architecture Entities page.
 * Task 2.5 — Entities E2E.
 */
test.describe("Architecture Entities", () => {
    const BASE_URL = "/es/architecture/entities";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /entities|entidades/i })
            .isVisible()
            .catch(() => false);
