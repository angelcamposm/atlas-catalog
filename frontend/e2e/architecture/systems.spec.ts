...
/**
 * E2E tests for the Architecture Systems page.
 * Task 2.4 — Systems E2E.
 */
test.describe("Architecture Systems", () => {
    const BASE_URL = "/es/architecture/systems";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /systems?|sistemas?/i })
            .isVisible()
            .catch(() => false);
