...
/**
 * E2E tests for the Infrastructure Types page.
 * Task 3.3 — Infra Types E2E.
 */
test.describe("Infrastructure Types", () => {
    const BASE_URL = "/es/infrastructure/types";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", {
                name: /infrastructure types|tipos de infraestructura/i,
            })
            .isVisible()
            .catch(() => false);
