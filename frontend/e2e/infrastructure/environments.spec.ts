...
/**
 * E2E tests for the Infrastructure Environments page.
 * Task 1.5 — Environments E2E.
 */
test.describe("Environments", () => {
    const BASE_URL = "/es/infrastructure/environments";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /environments?|entornos?/i })
            .isVisible()
            .catch(() => false);
