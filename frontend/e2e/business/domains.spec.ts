...
/**
 * E2E tests for the Business Domains page.
 * Task 2.6 — Domains E2E.
 */
test.describe("Business Domains", () => {
    const BASE_URL = "/es/business/domains";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /domains|dominios/i })
            .isVisible()
            .catch(() => false);
