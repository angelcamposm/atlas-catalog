...
/**
 * E2E tests for the Business Tiers taxonomy page.
 */
test.describe("Business Tiers", () => {
    const BASE_URL = "/es/taxonomy/business-tiers";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /tiers|niveles/i })
            .isVisible()
            .catch(() => false);
