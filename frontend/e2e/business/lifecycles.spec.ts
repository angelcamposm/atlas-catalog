...
/**
 * E2E tests for the Business Lifecycles page.
 * Task 2.7 — Lifecycles E2E.
 */
test.describe("Business Lifecycles", () => {
    const BASE_URL = "/es/business/lifecycles";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /lifecycle|ciclo de vida/i })
            .isVisible()
            .catch(() => false);
