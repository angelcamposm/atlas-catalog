...
/**
 * E2E tests for the Technology Languages page.
 * Task 1.8 — Languages E2E.
 */
test.describe("Technology Languages", () => {
    const BASE_URL = "/es/technology/languages";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /languages|lenguajes/i })
            .isVisible()
            .catch(() => false);
