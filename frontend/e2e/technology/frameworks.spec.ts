...
/**
 * E2E tests for the Technology Frameworks page.
 * Task 1.7 — Frameworks E2E.
 */
test.describe("Technology Frameworks", () => {
    const BASE_URL = "/es/technology/frameworks";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /frameworks|marcos/i })
            .isVisible()
            .catch(() => false);
