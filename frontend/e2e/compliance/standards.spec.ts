...
/**
 * E2E tests for the Compliance Standards page.
 * Task 6.2 — Compliance E2E.
 */
test.describe("Compliance Standards", () => {
    const BASE_URL = "/es/security/compliance";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /compliance|cumplimiento|standards/i })
            .isVisible()
            .catch(() => false);
