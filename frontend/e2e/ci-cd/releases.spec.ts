...
/**
 * E2E tests for the CI/CD Releases page.
 * Task 8.6 — CI/CD Releases E2E.
 */
test.describe("CI/CD Releases", () => {
    const BASE_URL = "/es/ci-cd/releases";
    ...
    test("list page loads and shows heading", async ({ page }) => {
        ...
        const hasHeading = await page
            .getByRole("heading", { name: /releases|versiones/i })
            .isVisible()
            .catch(() => false);
