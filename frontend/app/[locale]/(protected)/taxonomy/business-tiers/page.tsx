    ...
    const handleSubmit = async () => {
        try {
            ...
            if (editingTier) {
                ...
                await businessTiersApi.create(
                    data as CreateBusinessTierRequest,
                );
            }
            setDialogOpen(false);
            loadTiers();
        ...
        <div className="container mx-auto space-y-6 px-6 py-6">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {editingTier
                                ...
                                : "Define a new business criticality tier"}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="tier-description">
                                Description
                            </Label>
                            <Textarea
                                id="tier-description"
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            Delete Business Tier
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                            Are you sure you want to delete &quot;
                            {deletingTier?.name}&quot;? This action cannot be
                            undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
