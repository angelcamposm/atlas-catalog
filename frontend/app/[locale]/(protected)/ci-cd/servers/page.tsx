...
export async function generateMetadata(): Promise<Metadata> {
    return {
        title: `CI-Servers - Atlas Catalog`,
        description: "CI-Servers management",
    };
}

export default async function CIServersPage() {
    return (
            ...
            <div className="max-w-2xl w-full text-center space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-4 border border-gray-200 dark:border-gray-700">
                    <p className="text-lg text-gray-700 dark:text-gray-300">
                        Configure and monitor your continuous integration
                        servers.
                    </p>
                </div>
            </div>
