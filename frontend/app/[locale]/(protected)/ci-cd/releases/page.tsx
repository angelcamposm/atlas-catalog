...
export async function generateMetadata(): Promise<Metadata> {
    return {
        title: `Artifact Releases - Atlas Catalog`,
        description: "Artifact releases management",
    };
}

export default async function ArtifactReleasesPage() {
    return (
            ...
            <div className="max-w-2xl w-full text-center space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-4 border border-gray-200 dark:border-gray-700">
                    <p className="text-lg text-gray-700 dark:text-gray-300">
                        Manage and track your artifact releases across
                        environments.
                    </p>
                </div>
            </div>
