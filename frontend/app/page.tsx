            ...
            <main className="container mx-auto px-4 py-16">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Centralized API catalog management system for tracking
                        and managing your microservices, APIs, and digital
                        assets.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Browse and manage your complete API inventory
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Categorize your APIs by type: REST, GraphQL,
                                SOAP, and more.
                            </p>
                            <Link href="/api-types">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Track API lifecycle stages from development to
                                production.
                            </p>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Organize APIs by the programming languages they
                                use.
                            </p>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Group services by business domains for clear
                                ownership.
                            </p>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Track how APIs were discovered and registered in
                                the catalog.
                            </p>
                            <Button variant="ghost" className="w-full" disabled>
                                Coming Soon
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            ...
                            <p className="text-blue-800 dark:text-blue-200">
                                ...
                                for APIs, Types, Lifecycles, and more
                            </p>
                            <p className="text-blue-800 dark:text-blue-200">
                                <strong>Tech Stack:</strong> Next.js 15 +
