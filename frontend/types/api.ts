...
export interface UpdateLifecycleRequest extends Partial<CreateLifecycleRequest> {}
...
export interface UpdateProgrammingLanguageRequest extends Partial<CreateProgrammingLanguageRequest> {}
