...
jest.mock("react-icons/hi2", () => ({
    ...
    HiOutlineMagnifyingGlass: () => <span data-testid="icon-search">search</span>,
...
describe("QuickActionsWidget", () => {
    describe("Rendering", () => {
        it("renders widget title", () => {
            ...
            expect(screen.getByText(/Quick Actions|Acciones/i)).toBeInTheDocument();
        });
